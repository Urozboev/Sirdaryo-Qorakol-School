...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-157394867-1">
</script>
<script>
...
// map = new google.maps.Map(document.getElementById('#map_path'), {
//     center: latLng,
//     zoom: 15,
//     zoomControl: false,
...
//         if (status === 'OK') {
//             const address = results[0].formatted_addres;
